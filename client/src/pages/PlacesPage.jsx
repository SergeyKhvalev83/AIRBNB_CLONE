      ...
      {action === 'new' && (
        <div>
          <form>
            ...
            <div className="mt-2 grid grid-cols md: grid-cols-4 lg:grid-cals-6">
              {addedPhotos.length > 0 &&
                addedPhotos.map((eachPhoto, index) => (
                  <div key={index}>{eachPhoto}</div>
                  // <img key={Math.random(1000)} src={eachPhoto} alt="photoOfPlace" />
                ))}
